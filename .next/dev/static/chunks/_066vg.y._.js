...
function LeadForm({ listingName }) {
    ...
    async function handleSubmit(e) {
        ...
        try {
            const res = await fetch(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_FORMSPREE_URL, {
                method: 'POST',
                body: data,
                headers: {
            ...
            if (res.ok) {
                setStatus('success');
                form.reset();
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$analytics$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["trackLeadFormSubmit"])(listingName);
            } else {
                setStatus('error');
            }
        } catch  {
...
_s(LeadForm, "pMVgpsUAJOHrZfHrrx/6nNCpzkc=");
_c = LeadForm;
var _c;
...
//# sourceMappingURL=_066vg.y._.js.map